...
export function Hero() {
  return (
    <section id="home" className="relative pt-24 md:pt-36 pb-12 md:pb-20 overflow-hidden bg-background">
      ...
      <MouseSpotlight className="group">
        <div className="container relative mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center z-10">
          ...
          {/* Right column – CENTERPIECE 3D MODEL & FLOATING Badges */}
          <motion.div
          ...
          >
            ...
            <div className="relative rounded-[2.5rem] p-1 bg-gradient-to-br from-primary/30 to-secondary/30 shadow-2xl w-full max-w-[500px]">
              <div className="relative rounded-[2.4rem] overflow-hidden bg-background/80 backdrop-blur-md p-6">
                <SnakeBorder />
                ...
                <div className="absolute bottom-4 left-0 right-0 text-center pointer-events-none z-40">
                  <span className="text-[10px] text-primary/70 uppercase tracking-widest font-black glass px-3 py-1 rounded-full border border-primary/10">
                    ← Drag to Rotate 3D Enamel Model →
                  </span>
                </div>
              </div>
            </div>

            {/* Floating Luxury Clinic Interior Badge (3D tilted!) */}
            <ThreeDTilt
              maxTilt={20}
              className="absolute -right-4 -bottom-6 w-[200px] h-[150px] rounded-3xl p-1 bg-gradient-to-br from-primary/40 to-secondary/40 shadow-2xl z-40 hidden sm:block overflow-hidden"
            >
              <div className="relative w-full h-full rounded-[1.3rem] overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-end p-3 pointer-events-none">
                  <p className="text-white text-xs font-bold leading-tight">Luxury Treatment Rooms</p>
                </div>
              </div>
            </ThreeDTilt>
            ...
            <motion.div
              ...
              className="absolute -left-8 bottom-12 glass rounded-3xl p-6 shadow-2xl border border-primary/20 z-40 hidden sm:block"
            >
            ...
            <motion.div
              ...
              transition={{ delay: 1 }}
              className="absolute -right-2 top-6 glass rounded-2xl p-2.5 shadow-xl border border-primary/20 z-40"
            >
